...
console.log(Math); // output: Object [Maths] {}
...
// suppose we want random number between the given min and man range 
const min = 10
const max = 20
// then this is a trick/ formula to print random Number between given Range
